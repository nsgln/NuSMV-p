...
#include "NuSMV-2.6.0/NuSMV/code/nusmv/core/trace/exec/SATCompleteTraceExecutor_private.h"
...
#include "NuSMV-2.6.0/NuSMV/code/nusmv/core/trace/Trace_private.h"
